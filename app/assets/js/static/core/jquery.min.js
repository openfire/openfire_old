(function(window, undefined) {
    ...
    var rootjQuery, readyList, document = window.document, location = window.location, navigator = window.navigator, _jQuery = window.jQuery, _$ = window.$, core_push = Array.prototype.push, core_slice = Array.prototype.slice, core_indexOf = Array.prototype.indexOf, core_toString = Object.prototype.toString, core_hasOwn = Object.prototype.hasOwnProperty, core_trim = String.prototype.trim, jQuery = function(selector, context) {
        ...
        document.addEventListener ? (document.removeEventListener("DOMContentLoaded", DOMContentLoaded, !1), jQuery.ready()) : document.readyState === "complete" && (document.detachEvent("onreadystatechange", DOMContentLoaded), jQuery.ready());
    }, class2type = {};
    jQuery.fn = jQuery.prototype = {
        ...
        selector: "",
        jquery: "1.8.1pre -deprecated,-css,-ajax,-ajax/jsonp,-ajax/script,-ajax/xhr,-effects,-offset,-dimensions",
        length: 0,
        size: function() {
            return this.length;
        },
        ...
        pushStack: function(elems, name, selector) {
            ...
            return ret.prevObject = this, ret.context = this.context, name === "find" ? ret.selector = this.selector + (this.selector ? " " : "") + selector : name && (ret.selector = this.selector + "." + name + "(" + selector + ")"), ret;
        },
        ...
        each: function(obj, callback, args) {
            ...
            if (args) {
                ...
                } else for (; i < length; ) if (callback.apply(obj[i++], args) === !1) break;
            } else if (isObj) {
                for (name in obj) if (callback.call(obj[name], name, obj[name]) === !1) break;
            } else for (; i < length; ) if (callback.call(obj[i], i, obj[i++]) === !1) break;
            return obj;
        },
        ...
        makeArray: function(arr, results) {
            ...
            return arr != null && (type = jQuery.type(arr), arr.length == null || type === "string" || type === "function" || type === "regexp" || jQuery.isWindow(arr) ? core_push.call(ret, arr) : jQuery.merge(ret, arr)), ret;
        },
        ...
        map: function(elems, callback, arg) {
            ...
            if (isArray) for (; i < length; i++) value = callback(elems[i], i, arg), value != null && (ret[ret.length] = value); else for (key in elems) value = callback(elems[key], key, arg), value != null && (ret[ret.length] = value);
        ...
        access: function(elems, fn, key, value, chainable, emptyGet, pass) {
            ...
            if (key && typeof key == "object") {
                ...
                exec = pass === undefined && jQuery.isFunction(value), bulk && (exec ? (exec = fn, fn = function(elem, key, value) {
        ...
        if (!readyList) {
            ...
            if (document.readyState === "complete") setTimeout(jQuery.ready, 1); else if (document.addEventListener) document.addEventListener("DOMContentLoaded", DOMContentLoaded, !1), window.addEventListener("load", jQuery.ready, !1); else {
    ...
    jQuery.Callbacks = function(options) {
        ...
        Deferred: function(func) {
            ...
            return promise.pipe = promise.then, jQuery.each(tuples, function(i, tuple) {
                ...
                promise[tuple[1]] = list.add, stateString && list.add(function() {
                    state = stateString;
                }, tuples[i ^ 1][2].disable, tuples[2][2].lock), deferred[tuple[0]] = list.fire, deferred[tuple[0] + "With"] = list.fireWith;
        ...
        select = document.createElement("select"), opt = select.appendChild(document.createElement("option")), input = div.getElementsByTagName("input")[0], support = {
            ...
            html5Clone: document.createElement("nav").cloneNode(!0).outerHTML !== "<:nav></:nav>",
        ...
        !div.addEventListener && div.attachEvent && div.fireEvent && (div.attachEvent("onclick", clickFn = function() {
            support.noCloneEvent = !1;
        }), div.cloneNode(!0).fireEvent("onclick"), div.detachEvent("onclick", clickFn)), input = document.createElement("input"), input.value = "t", input.setAttribute("type", "radio"), support.radioValue = input.value === "t", input.setAttribute("checked", "checked"), input.setAttribute("name", "t"), div.appendChild(input), fragment = document.createDocumentFragment(), fragment.appendChild(div.lastChild), support.checkClone = fragment.cloneNode(!0).cloneNode(!0).lastChild.checked, support.appendChecked = input.checked, fragment.removeChild(input), fragment.appendChild(div);
        if (div.attachEvent) for (i in {
            submit: !0,
            change: !0,
            focusin: !0
        }) eventName = "on" + i, isSupported = eventName in div, isSupported || (div.setAttribute(eventName, "return;"), isSupported = typeof div[eventName] == "function"), support[i + "Bubbles"] = isSupported;
        return jQuery(function() {
            ...
            container = document.createElement("div"), container.style.cssText = "visibility:hidden;border:0;width:0;height:0;position:static;top:0;margin-top:1px", body.insertBefore(container, body.firstChild), div = document.createElement("div"), container.appendChild(div), div.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", tds = div.getElementsByTagName("td"), tds[0].style.cssText = "padding:0;margin:0;border:0;display:none", isSupported = tds[0].offsetHeight === 0, tds[0].style.display = "", tds[1].style.display = "none", support.reliableHiddenOffsets = isSupported && tds[0].offsetHeight === 0, div.innerHTML = "", div.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", support.boxSizing = div.offsetWidth === 4, support.doesNotIncludeMarginInBodyOffset = body.offsetTop !== 1, window.getComputedStyle && (support.pixelPosition = (window.getComputedStyle(div, null) || {}).top !== "1%", support.boxSizingReliable = (window.getComputedStyle(div, null) || {
                width: "4px"
            }).width === "4px", marginDiv = document.createElement("div"), marginDiv.style.cssText = div.style.cssText = divReset, marginDiv.style.marginRight = marginDiv.style.width = "0", div.style.width = "1px", div.appendChild(marginDiv), support.reliableMarginRight = !parseFloat((window.getComputedStyle(marginDiv, null) || {}).marginRight)), typeof div.style.zoom != "undefined" && (div.innerHTML = "", div.style.cssText = divReset + "width:1px;padding:1px;display:inline;zoom:1", support.inlineBlockNeedsLayout = div.offsetWidth === 3, div.style.display = "block", div.style.overflow = "visible", div.innerHTML = "<div></div>", div.firstChild.style.width = "5px", support.shrinkWrapBlocks = div.offsetWidth !== 3, container.style.zoom = 1), body.removeChild(container), container = div = tds = marginDiv = null;
    ...
    jQuery.extend({
        ...
        data: function(elem, name, data, pvt) {
            ...
            id || (isNode ? elem[internalKey] = id = jQuery.deletedIds.pop() || ++jQuery.uuid : id = internalKey), cache[id] || (cache[id] = {}, isNode || (cache[id].toJSON = jQuery.noop));
            if (typeof name == "object" || typeof name == "function") pvt ? cache[id] = jQuery.extend(cache[id], name) : cache[id].data = jQuery.extend(cache[id].data, name);
            return thisCache = cache[id], pvt || (thisCache.data || (thisCache.data = {}), thisCache = thisCache.data), data !== undefined && (thisCache[jQuery.camelCase(name)] = data), getByName ? (ret = thisCache[name], ret == null && (ret = thisCache[jQuery.camelCase(name)])) : ret = thisCache, ret;
        },
        removeData: function(elem, name, pvt) {
            ...
            if (name) {
                ...
                if (thisCache) {
                    jQuery.isArray(name) || (name in thisCache ? name = [ name ] : (name = jQuery.camelCase(name), name in thisCache ? name = [ name ] : name = name.split(" ")));
        ...
        data: function(key, value) {
            ...
            if (key === undefined) {
                if (this.length) {
                    ...
                    if (elem.nodeType === 1 && !jQuery._data(elem, "parsedAttrs")) {
                        ...
                        for (l = attr.length; i < l; i++) name = attr[i].name, name.indexOf("data-") === 0 && (name = jQuery.camelCase(name.substring(5)), dataAttr(elem, name, data[name]));
            ...
            return typeof key == "object" ? this.each(function() {
                ...
                if (value === undefined) return data = this.triggerHandler("getData" + part, [ parts[0] ]), data === undefined && elem && (data = jQuery.data(elem, key), data = dataAttr(elem, key, data)), data === undefined && parts[1] ? this.data(parts[0]) : data;
    ...
    jQuery.fn.extend({
            ...
            if (value && typeof value == "string") {
                ...
                for (i = 0, l = this.length; i < l; i++) {
                    ...
                    if (elem.nodeType === 1) if (!elem.className && classNames.length === 1) elem.className = value; else {
                        ...
                        for (c = 0, cl = classNames.length; c < cl; c++) ~setClass.indexOf(" " + classNames[c] + " ") || (setClass += classNames[c] + " ");
            ...
            if (value && typeof value == "string" || value === undefined) {
                ...
                for (i = 0, l = this.length; i < l; i++) {
                    ...
                    if (elem.nodeType === 1 && elem.className) {
                        ...
                        for (c = 0, cl = removes.length; c < cl; c++) while (className.indexOf(" " + removes[c] + " ") > -1) className = className.replace(" " + removes[c] + " ", " ");
        ...
        toggleClass: function(value, stateVal) {
            ...
            return jQuery.isFunction(value) ? this.each(function(i) {
                ...
                } else if (type === "undefined" || type === "boolean") this.className && jQuery._data(this, "__className__", this.className), this.className = this.className || value === !1 ? "" : jQuery._data(this, "__className__") || "";
            });
        },
        hasClass: function(selector) {
            var className = " " + selector + " ", i = 0, l = this.length;
            for (; i < l; i++) if (this[i].nodeType === 1 && (" " + this[i].className + " ").replace(rclass, " ").indexOf(className) > -1) return !0;
            return !1;
        },
        val: function(value) {
            ...
            return isFunction = jQuery.isFunction(value), this.each(function(i) {
                ...
                isFunction ? val = value.call(this, i, self.val()) : val = value, val == null ? val = "" : typeof val == "number" ? val += "" : jQuery.isArray(val) && (val = jQuery.map(val, function(value) {
        ...
        valHooks: {
            ...
            select: {
                get: function(elem) {
                    ...
                    i = one ? index : 0, max = one ? index + 1 : options.length;
                    for (; i < max; i++) {
                        option = options[i];
        ...
        attr: function(elem, name, value, pass) {
            ...
            notxml = nType !== 1 || !jQuery.isXMLDoc(elem), notxml && (name = name.toLowerCase(), hooks = jQuery.attrHooks[name] || (rboolean.test(name) ? boolHook : nodeHook));
            if (value !== undefined) {
                if (value === null) {
                    jQuery.removeAttr(elem, name);
                    return;
                }
                return hooks && "set" in hooks && notxml && (ret = hooks.set(elem, value, name)) !== undefined ? ret : (elem.setAttribute(name, "" + value), value);
            }
            return hooks && "get" in hooks && notxml && (ret = hooks.get(elem, name)) !== null ? ret : (ret = elem.getAttribute(name), ret === null ? undefined : ret);
        },
        removeAttr: function(elem, value) {
            var propName, attrNames, name, isBool, i = 0;
            if (value && elem.nodeType === 1) {
                attrNames = value.split(core_rspace);
                for (; i < attrNames.length; i++) name = attrNames[i], name && (propName = jQuery.propFix[name] || name, isBool = rboolean.test(name), isBool || jQuery.attr(elem, name, ""), elem.removeAttribute(getSetAttribute ? name : propName), isBool && propName in elem && (elem[propName] = !1));
            }
        },
        attrHooks: {
            type: {
    ...
    jQuery.event = {
        add: function(elem, types, handler, data, selector) {
            ...
            handler.handler && (handleObjIn = handler, handler = handleObjIn.handler, selector = handleObjIn.selector), handler.guid || (handler.guid = jQuery.guid++), events = elemData.events, events || (elemData.events = events = {}), eventHandle = elemData.handle, eventHandle || (elemData.handle = eventHandle = function(e) {
                return typeof jQuery == "undefined" || !!e && jQuery.event.triggered === e.type ? undefined : jQuery.event.dispatch.apply(eventHandle.elem, arguments);
            }, eventHandle.elem = elem), types = jQuery.trim(hoverHack(types)).split(" ");
            for (t = 0; t < types.length; t++) {
                ...
                }, handleObjIn), handlers = events[type];
                if (!handlers) {
                    handlers = events[type] = [], handlers.delegateCount = 0;
                    if (!special.setup || special.setup.call(elem, data, namespaces, eventHandle) === !1) elem.addEventListener ? elem.addEventListener(type, eventHandle, !1) : elem.attachEvent && elem.attachEvent("on" + type, eventHandle);
                }
        ...
        remove: function(elem, types, handler, selector, mappedTypes) {
            ...
            for (t = 0; t < types.length; t++) {
                tns = rtypenamespace.exec(types[t]) || [], type = origType = tns[1], namespaces = tns[2];
                if (!type) {
                    for (type in events) jQuery.event.remove(elem, type + types[t], handler, selector, !0);
                    continue;
                }
                special = jQuery.event.special[type] || {}, type = (selector ? special.delegateType : special.bindType) || type, eventType = events[type] || [], origCount = eventType.length, namespaces = namespaces ? new RegExp("(^|\\.)" + namespaces.split(".").sort().join("\\.(?:.*\\.|)") + "(\\.|$)") : null;
                for (j = 0; j < eventType.length; j++) handleObj = eventType[j], (mappedTypes || origType === handleObj.origType) && (!handler || handler.guid === handleObj.guid) && (!namespaces || namespaces.test(handleObj.namespace)) && (!selector || selector === handleObj.selector || selector === "**" && handleObj.selector) && (eventType.splice(j--, 1), handleObj.selector && eventType.delegateCount--, special.remove && special.remove.call(elem, handleObj));
                eventType.length === 0 && origCount !== eventType.length && ((!special.teardown || special.teardown.call(elem, namespaces, elemData.handle) === !1) && jQuery.removeEvent(elem, type, elemData.handle), delete events[type]);
            }
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            if (!elem || elem.nodeType !== 3 && elem.nodeType !== 8) {
                ...
                type.indexOf("!") >= 0 && (type = type.slice(0, -1), exclusive = !0), type.indexOf(".") >= 0 && (namespaces = type.split("."), type = namespaces.shift(), namespaces.sort());
                if ((!elem || jQuery.event.customEvent[type]) && !jQuery.event.global[type]) return;
                event = typeof event == "object" ? event[jQuery.expando] ? event : new jQuery.Event(type, event) : new jQuery.Event(type), event.type = type, event.isTrigger = !0, event.exclusive = exclusive, event.namespace = namespaces.join("."), event.namespace_re = event.namespace ? new RegExp("(^|\\.)" + namespaces.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, ontype = type.indexOf(":") < 0 ? "on" + type : "";
                if (!elem) {
                    cache = jQuery.cache;
                    for (i in cache) cache[i].events && cache[i].events[type] && jQuery.event.trigger(event, data, cache[i].handle.elem, !0);
                    return;
                }
                event.result = undefined, event.target || (event.target = elem), data = data != null ? jQuery.makeArray(data) : [], data.unshift(event), special = jQuery.event.special[type] || {};
                if (special.trigger && special.trigger.apply(elem, data) === !1) return;
                eventPath = [ [ elem, special.bindType || type ] ];
                if (!onlyHandlers && !special.noBubble && !jQuery.isWindow(elem)) {
                    bubbleType = special.delegateType || type, cur = rfocusMorph.test(bubbleType + type) ? elem : elem.parentNode;
                    for (old = elem; cur; cur = cur.parentNode) eventPath.push([ cur, bubbleType ]), old = cur;
                ...
                return event.type = type, !onlyHandlers && !event.isDefaultPrevented() && (!special._default || special._default.apply(elem.ownerDocument, data) === !1) && (type !== "click" || !jQuery.nodeName(elem, "a")) && jQuery.acceptData(elem) && ontype && elem[type] && (type !== "focus" && type !== "blur" || event.target.offsetWidth !== 0) && !jQuery.isWindow(elem) && (old = elem[ontype], old && (elem[ontype] = null), jQuery.event.triggered = type, elem[type](), jQuery.event.triggered = undefined, old && (elem[ontype] = old)), event.result;
            }
            return;
        },
        dispatch: function(event) {
            ...
            if (delegateCount && (!event.button || event.type !== "click")) {
                jqcur = jQuery(this), jqcur.context = this;
                for (cur = event.target; cur != this; cur = cur.parentNode || this) if (cur.disabled !== !0 || event.type !== "click") {
                    selMatch = {}, matches = [], jqcur[0] = cur;
                    for (i = 0; i < delegateCount; i++) handleObj = handlers[i], sel = handleObj.selector, selMatch[sel] === undefined && (selMatch[sel] = jqcur.is(sel)), selMatch[sel] && matches.push(handleObj);
            ...
            for (i = 0; i < handlerQueue.length && !event.isPropagationStopped(); i++) {
                matched = handlerQueue[i], event.currentTarget = matched.elem;
        ...
        fix: function(event) {
            ...
            for (i = copy.length; i; ) prop = copy[--i], event[prop] = originalEvent[prop];
            return event.target || (event.target = originalEvent.srcElement || document), event.target.nodeType === 3 && (event.target = event.target.parentNode), event.metaKey = !!event.metaKey, fixHook.filter ? fixHook.filter(event, originalEvent) : event;
        },
        special: {
            load: {
                noBubble: !0
        ...
        var name = "on" + type;
        elem.detachEvent && (typeof elem[name] == "undefined" && (elem[name] = null), elem.detachEvent(name, handle));
    }, jQuery.Event = function(src, props) {
        if (!(this instanceof jQuery.Event)) return new jQuery.Event(src, props);
        src && src.type ? (this.originalEvent = src, this.type = src.type, this.isDefaultPrevented = src.defaultPrevented || src.returnValue === !1 || src.getPreventDefault && src.getPreventDefault() ? returnTrue : returnFalse) : this.type = src, props && jQuery.extend(this, props), this.timeStamp = src && src.timeStamp || jQuery.now(), this[jQuery.expando] = !0;
        ...
        jQuery.fn[name] = function(data, fn) {
            return fn == null && (fn = data, data = null), arguments.length > 0 ? this.on(name, null, data, fn) : this.trigger(name);
        ...
        function multipleContexts(selector, contexts, results, seed) {
            ...
            for (; i < len; i++) Sizzle(selector, contexts[i], results, seed);
        }
        ...
        function handlePOS(selector, context, results, seed, groups) {
            var match, not, anchor, ret, elements, currentContexts, part, lastIndex, i = 0, len = groups.length, rpos = matchExpr.POS, rposgroups = new RegExp("^" + rpos.source + "(?!" + whitespace + ")", "i"), setUndefined = function() {
                var i = 1, len = arguments.length - 2;
                for (; i < len; i++) arguments[i] === undefined && (match[i] = undefined);
            };
            for (; i < len; i++) {
                rpos.exec(""), selector = groups[i], ret = [], anchor = 0, elements = seed;
                while (match = rpos.exec(selector)) {
                    lastIndex = rpos.lastIndex = match.index + match[0].length;
                    if (lastIndex > anchor) {
                        part = selector.slice(anchor, match.index), anchor = lastIndex, currentContexts = [ context ], rcombinators.test(part) && (elements && (currentContexts = elements), elements = seed);
                        if (not = rendsWithNot.test(part)) part = part.slice(0, -5).replace(rcombinators, "$&*");
                        match.length > 1 && match[0].replace(rposgroups, setUndefined), elements = handlePOSGroup(part, match[1], match[2], currentContexts, elements, not);
                    }
                }
        ...
        function tokenize(selector, context, xml) {
            var tokens, soFar, type, groups = [], i = 0, match = rselector.exec(selector), matched = !match.pop() && !match.pop(), selectorGroups = matched && selector.match(rgroups) || [ "" ], preFilters = Expr.preFilter, filters = Expr.filter, checkContext = !xml && context !== document;
            for (; (soFar = selectorGroups[i]) != null && matched; i++) {
                groups.push(tokens = []), checkContext && (soFar = " " + soFar);
                while (soFar) {
                    matched = !1;
                    if (match = rcombinators.exec(soFar)) soFar = soFar.slice(match[0].length), matched = tokens.push({
        ...
        function addCombinator(matcher, combinator, context) {
            ...
            return matcher || (matcher = function(elem) {
                return elem === context;
            }), combinator.first ? function(elem, context) {
                while (elem = elem[dir]) if (elem.nodeType === 1) return matcher(elem, context) && elem;
                ...
                while (elem = elem[dir]) if (elem.nodeType === 1) {
                    ...
                    if (typeof cache == "string" && cache.indexOf(dirkey) === 0) {
                        ...
                        if (matcher(elem, context)) return elem.sizset = !0, elem;
                        elem.sizset = !1;
                    }
                }
            };
        ...
        var cachedruns, dirruns, sortOrder, siblingCheck, assertGetIdNotName, document = window.document, docElem = document.documentElement, strundefined = "undefined", hasDuplicate = !1, baseHasDuplicate = !0, done = 0, slice = [].slice, push = [].push, expando = ("sizcache" + Math.random()).replace(".", ""), whitespace = "[\\x20\\t\\r\\n\\f]", characterEncoding = "(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+", identifier = characterEncoding.replace("w", "w#"), operators = "([*^$|!~]?=)", attributes = "\\[" + whitespace + "*(" + characterEncoding + ")" + whitespace + "*(?:" + operators + whitespace + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + identifier + ")|)|)" + whitespace + "*\\]", pseudos = ":(" + characterEncoding + ")(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|((?:[^,]|\\\\,|(?:,(?=[^\\[]*\\]))|(?:,(?=[^\\(]*\\))))*))\\)|)", pos = ":(nth|eq|gt|lt|first|last|even|odd)(?:\\((\\d*)\\)|)(?=[^-]|$)", combinators = whitespace + "*([\\x20\\t\\r\\n\\f>+~])" + whitespace + "*", groups = "(?=[^\\x20\\t\\r\\n\\f])(?:\\\\.|" + attributes + "|" + pseudos.replace(2, 7) + "|[^\\\\(),])+", rtrim = new RegExp("^" + whitespace + "+|((?:^|[^\\\\])(?:\\\\.)*)" + whitespace + "+$", "g"), rcombinators = new RegExp("^" + combinators), rgroups = new RegExp(groups + "?(?=" + whitespace + "*,|$)", "g"), rselector = new RegExp("^(?:(?!,)(?:(?:^|,)" + whitespace + "*" + groups + ")*?|" + whitespace + "*(.*?))(\\)|$)"), rtokens = new RegExp(groups.slice(19, -6) + "\\x20\\t\\r\\n\\f>+~])+|" + combinators, "g"), rquickExpr = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, rsibling = /[\x20\t\r\n\f]*[+~]/, rendsWithNot = /:not\($/, rheader = /h\d/i, rinputs = /input|select|textarea|button/i, rbackslash = /\\(?!\\)/g, matchExpr = {
        ...
        }, classCache = {}, cachedClasses = [], compilerCache = {}, cachedSelectors = [], markFunction = function(fn) {
            ...
            var pass = !1, div = document.createElement("div");
            try {
                pass = fn(div);
            } catch (e) {}
            ...
            return div.appendChild(document.createComment("")), div.getElementsByTagName("*").length === 0;
            ...
            return div.innerHTML = "<div class='hidden e'></div><div class='hidden'></div>", !div.getElementsByClassName || div.getElementsByClassName("e").length === 0 ? !1 : (div.lastChild.className = "e", div.getElementsByClassName("e").length !== 1);
            ...
            xml = isXML(context);
            if (!xml && !seed) if (match = rquickExpr.exec(selector)) if (m = match[1]) {
                if (nodeType === 9) {
            ...
            find: {
                ...
                TAG: assertTagNameNoComments ? function(tag, context) {
                    ...
                    if (tag === "*") {
                        var elem, tmp = [], i = 0;
                        for (; elem = results[i]; i++) elem.nodeType === 1 && tmp.push(elem);
                        return tmp;
                    }
                    return results;
                }
            ...
            preFilter: {
                ...
                CHILD: function(match) {
                    return match[1] = match[1].toLowerCase(), match[1] === "nth" ? (match[2] || Sizzle.error(match[0]), match[3] = +(match[3] ? match[4] + (match[5] || 1) : 2 * (match[2] === "even" || match[2] === "odd")), match[4] = +(match[6] + match[7] || match[2] === "odd")) : match[2] && Sizzle.error(match[0]), match;
                },
            ...
            filter: {
                ...
                CLASS: function(className) {
                    ...
                    return pattern || (pattern = classCache[className] = new RegExp("(^|" + whitespace + ")" + className + "(" + whitespace + "|$)"), cachedClasses.push(className), cachedClasses.length > Expr.cacheLength && delete classCache[cachedClasses.shift()]), function(elem) {
                    ...
                    if (type === "nth") {
                        ...
                        return function(elem) {
                            ...
                            if (parent && (parent[expando] !== doneName || !elem.sizset)) {
                                for (node = parent.firstChild; node; node = node.nextSibling) if (node.nodeType === 1) {
                                    node.sizset = ++count;
                                    if (node === elem) break;
                                }
                                parent[expando] = doneName;
                            }
                            return diff = elem.sizset - last, first === 0 ? diff === 0 : diff % first === 0 && diff / first >= 0;
                        };
                    }
                    return function(elem) {
                        var node = elem;
                ...
                PSEUDO: function(pseudo, argument, context, xml) {
                    ...
                    return fn || Sizzle.error("unsupported pseudo: " + pseudo), fn.sizzleFilter ? fn(argument, context, xml) : fn;
                }
            },
            pseudos: {
                ...
                empty: function(elem) {
                    ...
                    while (elem) {
                        if (elem.nodeName > "@" || (nodeType = elem.nodeType) === 3 || nodeType === 4) return !1;
            ...
            setFilters: {
                ...
                even: function(elements, argument, not) {
                    ...
                    for (; i < len; i += 2) results.push(elements[i]);
                    return results;
                },
        ...
        Expr.setFilters.nth = Expr.setFilters.eq, Expr.filters = Expr.pseudos, assertHrefNotNormalized || (Expr.attrHandle = {
            href: function(elem) {
        ...
        try {
            ...
            slice = function(i) {
                var elem, results = [];
                for (; elem = this[i]; i++) results.push(elem);
                return results;
            };
        }
        ...
        Sizzle.attr = function(elem, name) {
            ...
            return xml || (name = name.toLowerCase()), Expr.attrHandle[name] ? Expr.attrHandle[name](elem) : assertAttributes || xml ? elem.getAttribute(name) : (attr = elem.getAttributeNode(name), attr ? typeof elem[name] == "boolean" ? elem[name] ? name : null : attr.specified ? attr.value : null : null);
        }, Sizzle.error = function(msg) {
            throw new Error("Syntax error, unrecognized expression: " + msg);
        }, [ 0, 0 ].sort(function() {
            return baseHasDuplicate = 0;
        }), docElem.compareDocumentPosition ? sortOrder = function(a, b) {
            return a === b ? (hasDuplicate = !0, 0) : (!a.compareDocumentPosition || !b.compareDocumentPosition ? a.compareDocumentPosition : a.compareDocumentPosition(b) & 4) ? -1 : 1;
            ...
            if (sortOrder) {
                ...
                if (hasDuplicate) for (; elem = results[i]; i++) elem === results[i - 1] && results.splice(i--, 1);
            }
            return results;
        };
        var compile = Sizzle.compile = function(selector, context, xml) {
            ...
            for (i = 0; tokens = group[i]; i++) group[i] = matcherFromTokens(tokens, context, xml);
        ...
        var select = function(selector, context, results, seed, xml) {
            ...
            if (seed) elements = slice.call(seed, 0); else if (match && match.length === 1) {
                if (tokens.length > 1 && contextNodeType === 9 && !xml && (match = matchExpr.ID.exec(tokens[0]))) {
                    context = Expr.find.ID(match[1], context, xml)[0];
                    if (!context) return results;
                    selector = selector.slice(tokens.shift().length);
                }
                findContext = (match = rsibling.exec(tokens[0])) && !match.index && context.parentNode || context, notTokens = tokens.pop(), token = notTokens.split(":not")[0];
            ...
            if (selector) {
                matcher = compile(selector, context, xml), dirruns = matcher.dirruns++, elements == null && (elements = Expr.find.TAG("*", rsibling.test(selector) && context.parentNode || context));
                for (i = 0; elem = elements[i]; i++) cachedruns = matcher.runs++, matcher(elem, context) && results.push(elem);
            }
            return results;
        };
        document.querySelectorAll && function() {
            ...
            assert(function(div) {
                ...
                if (!seed && !xml && (!rbuggyQSA || !rbuggyQSA.test(selector))) if (context.nodeType === 9) try {
                    ...
                    try {
                        return push.apply(results, slice.call(newContext.querySelectorAll(selector.replace(rgroups, "[id='" + nid + "'] $&")), 0)), results;
                ...
                try {
                    matches.call(div, "[test!='']:sizzle"), rbuggyMatches.push(Expr.match.PSEUDO.source, Expr.match.POS.source, "!=");
                } catch (e) {}
            }), rbuggyMatches = new RegExp(rbuggyMatches.join("|")), Sizzle.matchesSelector = function(elem, expr) {
                expr = expr.replace(rattributeQuotes, "='$1']");
                if (!isXML(elem) && !rbuggyMatches.test(expr) && (!rbuggyQSA || !rbuggyQSA.test(expr))) try {
    ...
    jQuery.fn.extend({
        find: function(selector) {
            ...
            for (i = 0, l = this.length; i < l; i++) {
                length = ret.length, jQuery.find(selector, this[i], ret);
        ...
        index: function(elem) {
            return elem ? typeof elem == "string" ? jQuery.inArray(this[0], jQuery(elem)) : jQuery.inArray(elem.jquery ? elem[0] : elem, this) : this[0] && this[0].parentNode ? this.prevAll().length : -1;
        },
        ...
        jQuery.fn[name] = function(until, selector) {
            ...
            return runtil.test(name) || (selector = until), selector && typeof selector == "string" && (ret = jQuery.filter(selector, ret)), ret = this.length > 1 && !guaranteedUnique[name] ? jQuery.unique(ret) : ret, this.length > 1 && rparentsprev.test(name) && (ret = ret.reverse()), this.pushStack(ret, name, core_slice.call(arguments).join(","));
        };
    }), jQuery.extend({
        filter: function(expr, elems, not) {
            return not && (expr = ":not(" + expr + ")"), elems.length === 1 ? jQuery.find.matchesSelector(elems[0], expr) ? [ elems[0] ] : [] : jQuery.find.matches(expr, elems);
        },
    ...
    wrapMap.optgroup = wrapMap.option, wrapMap.tbody = wrapMap.tfoot = wrapMap.colgroup = wrapMap.caption = wrapMap.thead, wrapMap.th = wrapMap.td, jQuery.support.htmlSerialize || (wrapMap._default = [ 1, "X<div>", "</div>" ]), jQuery.fn.extend({
        ...
        append: function() {
            return this.domManip(arguments, !0, function(elem) {
                (this.nodeType === 1 || this.nodeType === 11) && this.appendChild(elem);
            });
        },
        prepend: function() {
            return this.domManip(arguments, !0, function(elem) {
                (this.nodeType === 1 || this.nodeType === 11) && this.insertBefore(elem, this.firstChild);
            });
        },
        before: function() {
        ...
        remove: function(selector, keepData) {
            var elem, i = 0;
            for (; (elem = this[i]) != null; i++) if (!selector || jQuery.filter(selector, [ elem ]).length) !keepData && elem.nodeType === 1 && (jQuery.cleanData(elem.getElementsByTagName("*")), jQuery.cleanData([ elem ])), elem.parentNode && elem.parentNode.removeChild(elem);
            return this;
        },
        empty: function() {
            var elem, i = 0;
        ...
        html: function(value) {
            return jQuery.access(this, function(value) {
                ...
                if (typeof value == "string" && !rnoInnerhtml.test(value) && (jQuery.support.htmlSerialize || !rnoshimcache.test(value)) && (jQuery.support.leadingWhitespace || !rleadingWhitespace.test(value)) && !wrapMap[(rtagName.exec(value) || [ "", "" ])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < l; i++) elem = this[i] || {}, elem.nodeType === 1 && (jQuery.cleanData(elem.getElementsByTagName("*")), elem.innerHTML = value);
                        elem = 0;
                    } catch (e) {}
                }
        ...
        replaceWith: function(value) {
            ...
            }) : (typeof value != "string" && (value = jQuery(value).detach()), this.each(function() {
        ...
        domManip: function(args, table, callback) {
            ...
            if (!jQuery.support.checkClone && l > 1 && typeof value == "string" && rchecked.test(value)) return this.each(function() {
            ...
            if (this[0]) {
                results = jQuery.buildFragment(args, this, scripts), fragment = results.fragment, first = fragment.firstChild, fragment.childNodes.length === 1 && (fragment = first);
                if (first) {
                    table = table && jQuery.nodeName(first, "tr");
                    for (iNoClone = results.cacheable || l - 1; i < l; i++) callback.call(table && jQuery.nodeName(this[i], "table") ? findOrAppend(this[i], "tbody") : this[i], i === iNoClone ? fragment : jQuery.clone(fragment, !0, !0));
                }
        ...
        return context = context || document, context = !context.nodeType && context[0] || context, context = context.ownerDocument || context, args.length === 1 && typeof first == "string" && first.length < 512 && context === document && first.charAt(0) === "<" && !rnocache.test(first) && (jQuery.support.checkClone || !rchecked.test(first)) && (jQuery.support.html5Clone || !rnoshimcache.test(first)) && (cacheable = !0, fragment = jQuery.fragments[first], cachehit = fragment !== undefined), fragment || (fragment = context.createDocumentFragment(), jQuery.clean(args, context, fragment, scripts), cacheable && (jQuery.fragments[first] = cachehit && fragment)), {
            fragment: fragment,
            cacheable: cacheable
        };
        ...
        jQuery.fn[name] = function(selector) {
            ...
            if ((parent == null || parent && parent.nodeType === 11 && parent.childNodes.length === 1) && l === 1) return insert[original](this[0]), this;
        ...
        clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            jQuery.support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test("<" + elem.nodeName + ">") ? clone = elem.cloneNode(!0) : (fragmentDiv.innerHTML = elem.outerHTML, fragmentDiv.removeChild(clone = fragmentDiv.firstChild));
            if ((!jQuery.support.noCloneEvent || !jQuery.support.noCloneChecked) && (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery.isXMLDoc(elem)) {
                cloneFixAttributes(elem, clone), srcElements = getAll(elem), destElements = getAll(clone);
        ...
        clean: function(elems, context, fragment, scripts) {
            ...
            for (safe = context === document && safeFragment; (elem = elems[i]) != null; i++) {
                ...
                if (typeof elem == "string") if (!rhtml.test(elem)) elem = context.createTextNode(elem); else {
                    safe = safe || createSafeFragment(context), div = div || safe.appendChild(context.createElement("div")), elem = elem.replace(rxhtmlTag, "<$1></$2>"), tag = (rtagName.exec(elem) || [ "", "" ])[1].toLowerCase(), wrap = wrapMap[tag] || wrapMap._default, depth = wrap[0], div.innerHTML = wrap[1] + elem + wrap[2];
                    while (depth--) div = div.lastChild;
                    if (!jQuery.support.tbody) {
                        hasBody = rtbody.test(elem), tbody = tag === "table" && !hasBody ? div.firstChild && div.firstChild.childNodes : wrap[1] === "<table>" && !hasBody ? div.childNodes : [];
                    ...
                    !jQuery.support.leadingWhitespace && rleadingWhitespace.test(elem) && div.insertBefore(context.createTextNode(rleadingWhitespace.exec(elem)[0]), div.firstChild), elem = div.childNodes, div = safe.lastChild;
                }
                elem.nodeType ? ret.push(elem) : ret = jQuery.merge(ret, elem);
            }
            div && (safe.removeChild(div), elem = div = safe = null);
            if (!jQuery.support.appendChecked) for (i = 0; (elem = ret[i]) != null; i++) jQuery.nodeName(elem, "input") ? fixDefaultChecked(elem) : typeof elem.getElementsByTagName != "undefined" && jQuery.grep(elem.getElementsByTagName("input"), fixDefaultChecked);
            if (fragment) {
    ...
    }, window.jQuery = window.$ = jQuery, typeof define == "function" && define.amd && define.amd.jQuery && define("jquery", [], function() {
        return jQuery;
    });
})(window);