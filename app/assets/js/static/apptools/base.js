  ...
  */
  ...
  AccordionAPI = (function(_super) {
    ...
    function AccordionAPI(apptools, widget, window) {
      ...
      this._init = function() {
        ...
        apptools.events.trigger('ACCORDION_READY', _this);
        _this._state.init = true;
        return _this;
      };
    }
  ...
  Accordion = (function(_super) {
    ...
    function Accordion(target, options) {
      ...
      this._init = function() {
        var accordion, c, current_fold, e, link, links, test, _i, _len;
        accordion = Util.get(_this._state.element_id);
  ...
  UploaderAPI = (function(_super) {
    ...
    function UploaderAPI(apptools, widget, window) {
      ...
      this.create = function(kind, options) {
        ...
        uploader = !(kind != null) ? new Uploader(options) : kind === 'data' ? new DataURLUploader(options) : kind === 'array' ? new ArrayBufferUploader(options) : new BinaryUploader(options);
        if ((options != null ? options.id : void 0) != null) {
          id = options.id;
          if (Util.is_id(id)) {
            uploader = _this.enable(uploader);
          }
        } else {
    ...
    function Uploader(options) {
      ...
      this.add_callback = function(callback) {
        if (Util.is_function(callback)) {
          _this._state.config.finish = callback;
        }
        return _this;
      };
      ...
      this.upload = function(e) {
        var diff, file, files, i, process_upload, _i, _len;
        if (e.preventDefault) {
          e.preventDefault();
          e.stopPropagation();
  ...
  BinaryUploader = (function(_super) {
    ...
    function BinaryUploader() {
      return BinaryUploader.__super__.constructor.apply(this, arguments);
    }
    ...
    function ArrayBufferUploader(options) {
      ...
      this.internal.send = function(file, data, url) {
        ...
        to_blob = function(dataURL) {
          var abuff, abuff_view, blobb, bytes, char, d, i, l, mime, _i, _len;
