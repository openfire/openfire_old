...
(function() {
  var AppException, AppTools, AppToolsCollection, AppToolsException, AppToolsModel, AppToolsRouter, AppToolsView, CoreAPI, CoreAgentAPI, CoreDevAPI, CoreDispatchAPI, CoreEventsAPI, CoreException, CoreInterface, CoreModelAPI, CoreObject, CorePushAPI, CoreRPCAPI, CoreRenderAPI, CoreStorageAPI, CoreUserAPI, CoreWidget, CoreWidgetAPI, Expand, Find, Milk, Modal, ModalAPI, Parse, PushDriver, QueryDriver, RPCAPI, RPCDriver, RPCRequest, RPCResponse, RenderDriver, StorageDriver, TemplateCache, Util,
    __slice = [].slice,
    ...
    function Modal(target, trigger) {
      ...
      this._state = {
        ...
        config: {
          ...
          template: ['<div id="modal-dialog" style="opacity: 0;" class="fixed dropshadow modal">', '<div id="modal-fade" style="opacity: 0">', '<div id="modal-content">&nbsp;</div>', '<div id="modal-ui" class="absolute">', '<div id="modal-title" class="absolute"></div>', '<div id="modal-close" class="absolute">X</div>', '</div>', '</div>', '</div>'].join('\n'),
          rounded: true
        }
      };
      ...
      this.make = function() {
        var close_x, content, d, dialog, doc, fade, id, prop, range, t, template, title, val, _ref;
      ...
      this.open = function() {
        ...
        final = _this.calc();
        final.opacity = 1;
        console.log("FINAL opacity: " + final.opacity);
        $(o).animate({
          opacity: 0.5
        }, overlay_animation);
