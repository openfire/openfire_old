...
(function() {
  ...
  Util = (function() {
    ...
    Util.prototype.create_element_string = function(tag, attrs, separator) {
  ...
  */
    ...
    function CoreRPCAPI(apptools, window) {
      ...
      this.rpc = {
        ...
        factory: function(name_or_apis, base_uri, methods, config) {
          ...
          if (name_or_apis.length != null) {
            _results = [];
            for (_i = 0, _len = name_or_apis.length; _i < _len; _i++) {
              api = name_or_apis[_i];
              _results.push(apptools.api[api.name] = new RPCAPI(api.name, api.base_uri, api.methods, api.config));
            }
            return _results;
          } else {
  ...
  ModalAPI = (function(_super) {
    ...
    function ModalAPI(apptools, widget, window) {
      ...
      this.create = function(target, trigger, callback, options) {
        ...
        if (callback != null) {
          return callback.call(_this, modal._init());
        } else {
          return modal._init();
        }
      };
  ...
  Modal = (function(_super) {
    ...
    function Modal(target, trigger, options) {
      ...
      this.make = function() {
        var close_x, content, d, dialog, fade, id, pre, prop, range, t, template, title, ui, val, _ref, _ref1;
