...
(function() {
  ...
  Util = (function() {
    ...
    Util.prototype.create_element_string = function(tag, attrs) {
    ...
    Util.prototype.add = function(element_type, attrs, parent_node) {
      var node_id, q_name,
        _this = this;
      if (!(element_type != null) || !this.is_object(attrs)) {
        return false;
      }
      q_name = this.is_body(parent_node) || !(parent_node != null) || !(node_id = parent_node.getAttribute('id')) ? 'dom' : node_id;
      if (!(this._state.queues[q_name] != null)) {
        this.internal.queues.add(q_name);
      }
    ...
    Util.prototype.bind = function(element, event, fn, prop) {
      var el, ev, evt, func, _i, _j, _len, _len1, _results, _results1, _results2;
      if (prop == null) {
        prop = false;
      }
      if (this.is_array(element)) {
        ...
        for (_j = 0, _len1 = event.length; _j < _len1; _j++) {
          evt = event[_j];
          _results1.push(this.bind(element, evt, fn, prop));
        }
        return _results1;
        ...
        for (ev in event) {
          func = event[ev];
          _results2.push(this.bind(element, ev, func, prop));
        }
        return _results2;
      } else {
    ...
    Util.prototype.unbind = function(element, event) {
      var el, ev, _i, _j, _len, _len1, _results, _results1, _results2;
      if (this.is_array(element)) {
        _results = [];
        for (_i = 0, _len = element.length; _i < _len; _i++) {
          el = element[_i];
        ...
        for (_j = 0, _len1 = event.length; _j < _len1; _j++) {
          ev = event[_j];
          _results1.push(this.unbind(element, ev));
        }
        return _results1;
        ...
        for (el in element) {
          ev = element[el];
          _results2.push(this.unbind(el, ev));
        }
        return _results2;
  ...
  */
  ...
  CoreWidgetAPI = (function(_super) {
    ...
    function CoreWidgetAPI(apptools, window) {
      var _this = this;
      this._init = function(apptools) {
  ...
  Modal = (function(_super) {
    ...
    function Modal(target, trigger, options) {
      ...
      this.make = function() {
        var close_x, content, d, dialog, fade, id, prop, range, t, template, title, ui, val, _ref;
  ...
  Scroller = (function(_super) {
    ...
    function Scroller(target, options) {
      ...
      this._init = function() {
        _this.classify();
        _this._state.init = true;
        $.apptools.events.trigger('SCROLLER_READY', _this);
        return _this;
      };
    }
  ...
  Tabs = (function(_super) {
    ...
    function Tabs(target, options) {
      ...
      this["switch"] = function(e) {
        ...
        current = currents != null ? currents[0] : ((_at = _this._state.active_tab) != null ? Util.get(_at) : false);
        if (e != null) {
          if (e.preventDefault) {
            e.preventDefault();
            e.stopPropagation();
  ...
  EditorAPI = (function(_super) {
    ...
    function EditorAPI(apptools, widget, window) {
      ...
      this._init = function() {
        ...
        return $.apptools.events.trigger('EDITOR_API_READY', _this);
      };
    }
  ...
  Editor = (function(_super) {
    ...
    function Editor(target, options) {
      ...
      this._state.config = Util.extend(true, this._state.config, options);
      this.make = function() {
        var button, command, feature, features, k, pane, pane_id, t, t_id, t_off, v, width, _ref;
      ...
      this.show = function() {
        var p;
        $('#' + (p = _this._state.pane_id)).animate({
          opacity: 1
        }, Util.prep_animation());
        return _this;
      };
      this.hide = function() {
        $('#' + _this._state.pane_id).animate({
          opacity: 0
        }, Util.prep_animation());
        return _this;
      };
      this.edit = function() {
        ...
        _this._state.active = true;
        Util.bind(el, 'dblclick', _this.save);
        el.focus();
        return _this;
      };
      this.save = function() {
      ...
      this._init = function() {
        ...
        $.apptools.events.trigger('EDITOR_READY', this);
        return this;
      };
    }
  ...
  UploaderAPI = (function(_super) {
    ...
    function UploaderAPI(apptools, widget, window) {
      ...
      this._init = function(apptools) {
        var uploader, uploaders, _i, _len;
        uploaders = Util.get('pre-uploader');
        for (_i = 0, _len = uploaders.length; _i < _len; _i++) {
          uploader = uploaders[_i];
          _this.enable(_this.create(uploader));
        }
    ...
    function Uploader(options) {
      ...
      this.internal = {
        allow: function(file) {
          ...
          if (Util.in_array(type, _this._state.config.banned_types)) {
            return false;
          }
          return true;
        },
      ...
      this.handle = function(e) {
        ...
        switch (e.type) {
          case 'dragenter':
          case 'dragover':
            return target.style.border = '2px dashed green';
          case 'dragexit':
          case 'dragleave':
            return target.style.border = '2px solid transparent';
        }
      };
