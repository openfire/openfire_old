...
(function() {
  ...
  ProjectEditError = (function(_super) {
    ...
    function ProjectEditError() {
      return ProjectEditError.__super__.constructor.apply(this, arguments);
    }
  ...
  BBQController = (function() {
    ...
    BBQController.prototype.initBbqNewInlines = function() {
      ...
      $('button.cancel-new-dialog').click(function() {
        ...
        if ((_ref1 = $.apptools.widgets.modal.get('new-proposal-dialog')) != null) {
          _ref1.close();
        }
        return (_ref2 = $.apptools.widgets.modal.get('new-custom-url-dialog')) != null ? _ref2.close() : void 0;
      });
      ...
      this.from_message = function(message) {
        ...
        validate = function(k, v) {
          if ((k != null) && (v != null)) {
            ...
            if (v.constructor.name !== model[k].constructor.name) {
              return false;
            }
            return true;
          } else {
