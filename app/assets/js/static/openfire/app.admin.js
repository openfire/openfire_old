(function() {
  var ActivityGraph, ActivityItem, Asset, AuthController, BBQBaseObject, BBQCategory, BBQController, BBQCustomUrl, BBQProject, BBQProposal, Back, Follow, Goal, Key, MediaError, Openfire, OpenfireController, OpenfireException, OpenfireObject, Project, ProjectAvatar, ProjectCard, ProjectController, ProjectEditError, ProjectImage, ProjectVideo, Proposal, ProposalController, Session, Tier, Update, User, UserController, UserPermissionsError, Util, fulfillRequest,
  ...
  BBQBaseObject = (function() {
    ...
    function BBQBaseObject(el) {
      ...
      this._element.find('button.start-edit').click(function() {
        ...
        return _this._element.find('.bbq-editable').each(function() {
    ...
    BBQBaseObject.prototype.loadData = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        dataName = _ref[_i];
        _results.push(this._dataDict[dataName] = this.getAttr(this.dataPrefix, dataName));
      }
      return _results;
    };
  ...
  BBQCategory = (function(_super) {
    ...
    function BBQCategory(el) {
      ...
      this.dataPrefix = 'category';
      BBQCategory.__super__.constructor.call(this, el);
      this.categoryKey = this.getAttr('category', 'key');
    }
  ...
  BBQProposal = (function(_super) {
    ...
    function BBQProposal(el) {
      ...
      this.dataPrefix = 'proposal';
      BBQProposal.__super__.constructor.call(this, el);
      this.proposalKey = this.getAttr('proposal', 'key');
  ...
  BBQProject = (function(_super) {
    ...
    function BBQProject(el) {
      ...
      document.getElementById('add-project-' + this.projectKey + '-video').addEventListener('click', this.addVideo, false);
    }
    ...
    BBQProject.prototype.addVideo = function(e) {
      var provider, url,
        _this = this;
      ...
      return $.apptools.api.media.attach_video({
        ...
        success: function(response) {
          return alert('Video attached.');
        },
        failure: function(error) {
          return alert('Failed to attach a video.');
        }
      });
    };
  ...
  BBQController = (function() {
    ...
    BBQController.prototype.initBbqObjects = function() {
      ...
      $('#start-add-new-category').click(function(e) {
        var self;
        self = $(this);
        self.hide();
        return self.next('.dialog-form').show();
      });
    ...
    BBQController.prototype.initBbqNewInlines = function() {
      var _this;
      _this = this;
      $('button.cancel-new-dialog').click(function() {
        var _ref, _ref2, _ref3;
        if ((_ref = $.apptools.widgets.modal.get('new-category-dialog')) != null) {
          _ref.close();
        }
        if ((_ref2 = $.apptools.widgets.modal.get('new-proposal-dialog')) != null) {
          _ref2.close();
        }
        return (_ref3 = $.apptools.widgets.modal.get('new-custom-url-dialog')) != null ? _ref3.close() : void 0;
      });
      return $('button.save-new-dialog').click(function() {
        ...
        if (request) return fulfillRequest(request, 'Failed to something.');
      });
    };
