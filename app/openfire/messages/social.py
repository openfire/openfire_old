...
class Follow(messages.Message):
    ...
    class NotificationOptions(messages.Message):
        ...
        transport = messages.EnumField(Transport, 2, repeated=True, default=[Transport.EMAIL])
    ...
    class FollowSubject(messages.Message):
        ...
        key = messages.StringField(1)
	    kind = messages.EnumField(2, SubjectType)
	    user = messages.MessageField(3, Follower)
	    project = messages.MessageField(4, Project)
