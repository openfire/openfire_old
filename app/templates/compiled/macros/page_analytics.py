        ...
        def macro(l_config):
            ...
            if environment.getattr(l_config, 'enable'):
                ...
                t_1.extend((
                    ...
                    to_string(context.call(environment.getattr(environment.getattr(environment.getattr(l_util, 'request'), 'env'), 'get'), 'HTTP_HOST', 'open-fire-staging.appspot.com')), 
