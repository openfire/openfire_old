...
def run(environment):
    ...
    def root(context, environment=environment):
        ...
        for l_category in l_categories:
            if 0: yield None
            yield u'\n    <li id="category-%s">\n        <p id="category-display-%s">\n            <span>%s</span>\n            <span>%s</span>\n            <span>%s</span>\n        </p>\n        <p id="category-inputs-%s" style="display: none;">\n            <span><input class="name-input" value="%s"></span>\n            <span><input class="slug-input" value="%s" disabled="disabled"></span>\n            <span><input class="description-input" value="%s"></span>\n        </p>\n        <span>\n            <button id="delete-category-%s" class="delete-object" type="button">delete</button>\n            <button id="start-edit-category-%s" class="start-edit-inline" type="button">edit</button>\n            <button id="cancel-edit-category-%s" class="cancel-edit-inline" type="button" style="display: none;">cancel</button>\n            <button id="save-edit-category-%s" class="save-edit-inline" type="button" style="display: none;">save</button>\n        </span>\n    </li>\n    ' % (
