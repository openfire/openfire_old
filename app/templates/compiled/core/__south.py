...
def run(environment):
    ...
    def root(context, environment=environment):
        ...
        if context.call(environment.getattr(environment.getattr(environment.getattr(l_util, 'api'), 'users'), 'is_current_user_admin')):
            if 0: yield None
            yield u'<script src="/assets/js/static/openfire/app.admin.js"></script>'
        else:
            if 0: yield None
            yield u'<script src="%s"></script>' % (
    ...
    def block_page_analytics(context, environment=environment):
        ...
        if environment.getattr(l_page, 'analytics'):
            ...
            if l_google_analytics_async is missing:
                l_google_analytics_async = environment.undefined("the template %r (imported on line 42 in '/source/core/__south.html') does not export the requested name 'google_analytics_async'" % included_template.__name__, name='google_analytics_async')
            yield u'\n\t\t'
    ...
    debug_info = '2=12&5=13&6=14&8=15&12=17&15=23&19=26&22=32&31=35&33=38&40=41&33=45&34=49&35=51&36=56&40=58&41=62&42=64&43=69'
    return locals()